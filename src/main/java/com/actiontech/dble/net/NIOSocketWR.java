...
public class NIOSocketWR extends SocketWR {
    ...
    public void doNextWriteCheck() {
        ...
        try {
            ...
            if (con instanceof MySQLConnection) {
                ...
                errMsg = "Connection {dbInstance[" + mysqlCon.getHost() + ":" + mysqlCon.getPort() + "],Schema[" + mysqlCon.getSchema() + "],threadID[" +
            ...
            while (buffer.hasRemaining()) {
                ...
                try {
                    ...
                    if (!quitFlag) {
                        ...
                        startClearCon();
                        con.isClosed = true;
                        AbstractConnection.LOGGER.info("writeDirectly quit error and ignore ");
                        return true;
                    }
                }
            }
    ...
    private void disableWrite() {
        try {
            ...
            AbstractConnection.LOGGER.info("can't disable writeDirectly " + e + " con " + con);
        }
    ...
    private void enableWrite(boolean wakeup) {
        ...
        try {
            ...
            AbstractConnection.LOGGER.info("can't enable writeDirectly " + e);
