...
import com.actiontech.dble.backend.mysql.nio.handler.FieldsListHandler;
...
public final class FieldsList {
    ...
    public static void response(ServerConnection c, String stmt) {
        ...
        try {
            ...
            FieldsListHandler fieldsListHandler = new FieldsListHandler(c.getSession2(), rrs);
